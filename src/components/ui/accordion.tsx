...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 px-6 font-medium transition-all hover:bg-primary/5 [&[data-state=open]]:bg-primary/5 [&[data-state=open]>svg]:rotate-180",
        className
      )}
      {...props}
    >
